...
async function main() {
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  console.log('🌊 StackFlow FLOW Token Ecosystem Deployment');
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
  
  console.log('⚠️  WARNING: Deploying to MAINNET!');
  console.log('This will deploy 3 contracts and cost ~3.0 STX\n');
  ...
  try {
    ...
    // Read contract files
    const flowTokenCode = readFileSync('./contracts/stackflow-flow-token.clar', 'utf8');
    ...
    // Deploy 1: FLOW Token
    console.log('\n━━━ Phase 1: FLOW Token ━━━');
    const flowDeployment = await deployContract(
    ...
    deployments.push({ name: 'FLOW Token', ...flowDeployment });
    currentNonce++;
    ...
    // Deploy 3: Governance Contract
    console.log('\n━━━ Phase 3: Governance Contract ━━━');
    ...
    console.log('2. 🎯 Configure distribution wallets');
    console.log('   Call configure-distribution-wallets on FLOW token\n');
    
    console.log('3. 💰 Mint initial distribution');
    console.log('   Call mint-initial-distribution on FLOW token\n');
    
    console.log('4. 📄 Update frontend .env');
    console.log(`   Add these lines:\n`);
    console.log(`   VITE_FLOW_TOKEN_ADDRESS=${deployments[0].contractAddress}`);
    console.log(`   VITE_STAKING_CONTRACT_ADDRESS=${deployments[1].contractAddress}`);
    console.log(`   VITE_GOVERNANCE_CONTRACT_ADDRESS=${deployments[2].contractAddress}\n`);
    
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
    console.log('🌊 The Flow has been unleashed on mainnet!');
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
